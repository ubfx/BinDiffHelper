...
public class ComparisonTableModel extends AbstractTableModel {
	...
	private String[] columnNames = { "Import", "Address this file", "Name this file", "Name Database",
			"Address other file", "Name other file", "Similarity", "Confidence", "Algorithm" };
	...
	public static class Entry {
		...
		public Entry(boolean i, Address pa, String pfn, Symbol pfs, long sa, String sfn, double sim, double con,
				String alg) {
			do_import = i;
			primaryAddress = pa;
